...
class botaoAcoes extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            currentEmailAssociado: null,
            currentAssociatedPayments: []
        }
    }

    // mostra individualmente os detalhes dos associados.
    ...
    getAssociadosDetalhes = (id) => {
        axios.post('/get/individual/associado/detalhes', {
            ...
            this.setState({
                ...
                currentEmailAssociado: response.data.email_associado,
                currentAssociatedPayments: response.data.pagamento
            })
